...
url = "https://delassus.com/en/products/citrus"
...
def test_products_block_links(browser):
    ...
    page.go_to_site()
    page.page_is_loaded()
    assert page.get_products_block_links() == ['https://delassus.com/en/products/grapes', 'https://delassus.com/en/products/avocados',
                                               'https://delassus.com/en/products/flowers', 'https://delassus.com/en/products/tomatoes']
