...
url = "https://delassus.com/en/products/flowers"
...
def test_link_contact_us(browser):
    ...
    page.go_to_site()
    page.page_is_loaded()
    assert page.get_link_contact_us() == "mailto:contact@primrose-flowers.com"
...
def test_products_block_links(browser):
    ...
    page.go_to_site()
    page.page_is_loaded()
    assert page.get_products_block_links() == ['https://delassus.com/en/products/tomatoes', 'https://delassus.com/en/products/citrus',
