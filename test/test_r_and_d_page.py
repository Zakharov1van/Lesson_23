...
def test_logo_link(browser):
    ...
    page.go_to_site()
    page.page_is_loaded()
    assert page.get_logo_link() == "https://duroc.ma/"
...
def test_products_block_links(browser):
    ...
    page.go_to_site()
    page.page_is_loaded()
    assert page.get_products_block_links() == ['https://delassus.com/en/about', 'https://delassus.com/en/csr',
